...
urlpatterns = [
    ...
    # CRUD Category
    path('menu-builder/category/<int:pk>/', views.fooditems_by_category, name='fooditems_by_category'), # READ
    path('menu-builder/category/add/', views.add_category, name='add_category'), # CREATE
    path('menu-builder/category/edit/<int:pk>', views.edit_category, name='edit_category'), # EDIT
    path('menu-builder/category/delete/<int:pk>', views.delete_category, name='delete_category'), # UPDATE
    # CRUD Food
